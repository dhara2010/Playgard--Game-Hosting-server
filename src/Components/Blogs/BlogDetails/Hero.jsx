    ...
    return (
        <div>
            <div className='-mt-200 text-white gradient'>
                <div className="px-4 lg:px-30 pt-50">
                    <div className="flex justify-center items-center flex-col">
                        ...
                        <h1 className='font-bold tet-3xl lg:text-5xl max-w-4xl text-center'>Palworld, the Unique blend of Creature Captivated Players Worldwide.</h1>
                        <div className="flex flex-wrap justify-between items-center gap-2 lg:gap-4 mt-6">
                            <p>Saiful Talukdar</p>
                ...
                <div className="mt-10 px-5 lg:px-55">
