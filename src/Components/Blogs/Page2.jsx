...
function Page2() {
  return (
    <div>
      <div className='bg-dark lg:h-320 text-white'>
            <div className="flex flex-col justify-center items-center">
                ...
                <h1 className="text-white text-2xl lg:text-5xl max-w-3xl text-center font-serif font-bold mt-8">Check Back Here Regularly for News Updates</h1>
            </div>
            ...
            <div className="flex justify-center items-center mt-8">
                <p className='font-semibold px-4'>We have more Recent Blog for extra knowledge. <span className='gradient-text'>More Blog.</span></p>
            </div>
        </div>
    </div>
  )
