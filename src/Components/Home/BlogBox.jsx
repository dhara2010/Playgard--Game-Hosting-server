...
function BlogBox({img}) {
    return (
        <div className='mt-16'>
            <div className="flex flex-col relative lg:w-88 group overflow-hidden">
                <img src={img} alt="image" className='lg:w-88 h-78 object-cover' />
                <div className='-mt-15 bg-dark p-6 lg:ml-8 w-11/12 transition-all duration-500 ease-in-out origin-right group-hover:w-full group-hover:ml-0'>
