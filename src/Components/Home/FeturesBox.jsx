    ...
    return (
        <div className=''>
            <div className="flex justify-between items-center">
                <div className="relative group text-white bg-dark p-4 rounded-lg border border-neutral-700 w-full min-h-[280px] lg:min-h-[320px] flex flex-col items-center justify-center text-center overflow-hidden">
