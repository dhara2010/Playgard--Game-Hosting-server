        ...
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30 pt-30">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 justify-center">
                    <div className='flex'>
                        <img src="./images/home/abc_company.webp" alt="" className='w-full opacity-70 relative' />
                        <img src="./images/home/abc_company_1.webp" alt="" className='hidden md:block absolute ml-0 md:ml-30 lg:ml-55 md:mt-3' />
                        <img src="./images/home/abc_company_2.webp" alt="" className='hidden md:block absolute mt-40 md:mt-80 lg:-ml-40' />
                    </div>
                    <div className='flex flex-col gap-5 lg:ml-22'>
                        ...
                        <h1 className='text-3xl lg:text-5xl font-bold leading-tight'>Why We are the Best Server?</h1>
                        ...
                        <div className="flex flex-wrap justify-between gap-5 items-center">
                            <div className="border border-neutral-600/20 rounded-xl bg-neutral-700/20 p-6 w-full md:w-55">
