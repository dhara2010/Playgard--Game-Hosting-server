...
function Hero() {
    ...
    return (
        <div className='-mt-190 text-white gradient pt-32 lg:pt-48'>
            <div className="">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-10">
                    <div className="px-4 lg:px-30 w-full lg:w-1/2 text-center lg:text-left">
                        ...
                        <h1 className="font-bold text-3xl lg:text-6xl max-w-xl mt-3 leading-tight">An Open-World Gaming Server Hosting</h1>
                    ...
                    <div className="w-full lg:w-134 lg:-mt-20">
