    ...
    return (
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30 pt-10">
               ...
               <div className="flex flex-col lg:flex-row mt-30 gap-10 lg:px-10">
                   <div className="lg:w-2/5 flex flex-col">
                        <h1 className='text-2xl lg:text-5xl leading-tight font-bold'>Why We are the Best Server?</h1>
