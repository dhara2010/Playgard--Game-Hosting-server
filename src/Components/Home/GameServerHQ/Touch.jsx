        ...
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30 pt-30">
                <div className="flex flex-col justify-between items-center">
                    ...
                    <h1 className="text-2xl lg:text-5xl font-bold mt-5 max-w-3xl leading-tight text-center">Have Questions? Contact us for Expert Advice</h1>
                    <div className="flex flex-wrap justify-center gap-5">
                        <a href="/contact">
                            <div className="border border-indigo-400 bg-indigo-400/10 p-4 rounded-xl mt-5 w-70 md:w-80">
                                <div className="flex items-center gap-2">
                                    ...
                                    <div>
                                        <h1 className='md:text-xl font-bold'>Open Ticket</h1>
                        ...
                        <a href="/contact">
                            <div className="border border-orange-400 bg-orange-400/10 p-4 rounded-xl mt-5 w-70 md:w-80">
                                <div className="flex items-center gap-2">
                                    <div className="flex justify-center items-center">
                                        <div className="bg-white w-15 h-15 rounded-xl flex justify-center items-center">
                                    ...
                                    <div>
                                        <h1 className='md:text-xl font-bold'>Connect On Discord</h1>
