        ...
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30">
                <div className="flex justify-center flex-col items-center">
                    ...
                    <h1 className="text-2xl lg:text-5xl font-bold mt-4 max-w-3xl leading-tight text-center">Our Clients' Experiences Speak Volumes</h1>
                </div>
                <div className="mt-5">
                ...
                <div className="flex justify-center items-center relative mt-8">
                    <div className="group inline-block lg:-mt-11">
