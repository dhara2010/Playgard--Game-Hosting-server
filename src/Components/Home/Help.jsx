    ...
    <div className="h-150 bg-center bg-cover bg-black" style={{ backgroundImage: "url('/images/hero_bg_3.webp')" }}>
            <main className="pt-30 lg:pt-10">
                <section className="h-[68vh] flex flex-col justify-center items-center text-center gap-4">
                    <h1 className="text-white text-3xl lg:text-5xl font-serif font-bold max-w-3xl leading-tight">
                        Have any Questions? We're Here to Help!
                    </h1>
                    <div className="flex flex-wrap px-4 justify-between text-white gap-4 font-semibold">
