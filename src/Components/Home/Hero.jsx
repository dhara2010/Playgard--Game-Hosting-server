    ...
    return (
        <div className='-mt-200'>
            <main className="pt-40">
                <section className="lg:h-[68vh] flex flex-col justify-center items-center text-center gap-4 lg:gap-8">
                    ...
                    <h1 className="text-white text-4xl lg:text-6xl font-serif font-bold max-w-3xl leading-tight">
                ...
                <section className="grid grid-cols-1 lg:grid-cols-3 lg:h-[100vh] pt-15 lg:px-30">
                    <div className="md:col-span-2 gap-4 bg-dark lg:h-80 p-4 md:p-6 pt-8 text-white flex">
                        <div>
                            <img src="/images/v_card_icon_1.webp" alt="" className="h-10 lg:h-20 bg-pink-400/10 rounded-full" />
                            <h2 className="text-xl lg:text-5xl font-bold mt-6">45% of user</h2>
                            <p className="mt-6 text-xs lg:text-[20px]">Points of Presence Worldwide Datacenters</p>
                        </div>
                        <div>
                            <img src="/images/v_card_icon_2.webp" alt="" className="h-10 lg:h-20 bg-pink-400/10 rounded-full" />
                            <h2 className="text-xl lg:text-5xl font-bold mt-6">$10k Reviews</h2>
                            <p className="mt-6 text-xs lg:text-[20px]">Points of Presence Worldwide Datacenters</p>
                        </div>
                    </div>
                    <div className="col-span-1 relative lg:ml-6">
                        <img src="/images/video_img.webp" alt="image" className="h-75 w-full" />
                        <div className="absolute inset-0 flex justify-center items-center">
                            <div className="flex justify-center items-center lg:-mt-80 size-20 bg-orange-500/20 rounded-full cursor-pointer animate-pulse-border">
