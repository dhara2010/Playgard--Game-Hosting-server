...
function ReviewBox({img}) {
    return (
        <div className="flex justify-between items-center">
            <div className="relative group text-white bg-dark p-3 lg:p-6 rounded-lg border border-neutral-700 w-full min-h-[260px] lg:min-h-[320px] flex flex-col overflow-hidden">
