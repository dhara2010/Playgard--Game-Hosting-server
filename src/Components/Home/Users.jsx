...
function Users() {
    return (
        <div className="bg-dark lg:min-h-[800px] lg:px-10 py-20 lg:-mt-120">
            <div className="grid grid-cols-1 md:grid-cols-2 md:gap-5 lg:gap-10 items-center pt-10 lg:pt-30 px-4 lg:px-20">
                <div>
                    <img src="/images/about_img.webp" alt="About Us" className="rounded-xl" />
                </div>
                <div className="text-white lg:pt-40">
                    ...
                    <h1 className="text-3xl lg:text-5xl max-w-2xl leading-tight font-bold pt-4"> We Have teams that Can Provide Work.</h1>
                    ...
                    <div className="flex flex-wrap justify-between items-center gap-4 pt-7">
                    ...
                    <div className="flex flex-wrap justify-between items-center gap-4 mt-7">
