    ...
    return (
        <div className='bg-dark -mt-50 text-white'>
            <div className="px-4 lg:px-30">
                <div className="flex flex-wrap md:flex-nowrap justify-between items-center gap-4 pt-68">
                    <div className="flex-flex-col">
                        <h1 className='text-xl lg:text-2xl font-bold'><span className='text-2xl lg:text-5xl'>45%</span> of User</h1>
                        <p className='mt-4 max-w-[25ch]'>Points of Presence Worldwide Datacenters</p>
                    </div>
                    <div className="flex-flex-col">
                        <h1 className='text-xl lg:text-2xl font-bold'><span className='text-2xl lg:text-5xl'>4k+</span> Game Server</h1>
                        <p className='mt-4 max-w-[25ch]'>Points of Presence Worldwide Datacenters</p>
                    </div>
                    <div className="flex-flex-col">
                        <h1 className='text-xl lg:text-2xl font-bold'><span className='text-2xl lg:text-5xl'>30m</span> Satisfied Customers</h1>
                        <p className='mt-4 max-w-[25ch]'>Points of Presence Worldwide Datacenters</p>
                    </div>
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-2 mt-30 gap-5 justify-between">
                    <h4 className='text-2xl lg:text-4xl font-bold'>We've built our business on the Premise of providing Honest, High-Performance Hosting Services for less.</h4>
                    <div className='flex flex-col gap-4 text-sm lg:text-[18px]'>
                ...
                <div className="flex justify-center items-center text-center flex-col mt-30">
                    <h1 className='text-2xl lg:text-5xl font-bold'>Why Host With Us?</h1>
