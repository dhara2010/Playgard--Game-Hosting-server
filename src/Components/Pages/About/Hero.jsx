        ...
        <div className='gradient -mt-150 text-white'>
            <div className="px-4 lg:px-30">
                ...
                <div className="flex flex-wrap justify-between items-center mt-5">
                    <h1 className='text-3xl lg:text-7xl leading-tight max-w-2xl font-bold'>What you Need to know About Us</h1>
                    <p className='max-w-xs lg:pt-25'>World class development and built for performance, Taskify will deliver every time.</p>
                </div>
                <div className="mt-5">
