...
function Team() {
    return (
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30 pt-30 pb-30">
                <div className="flex flex-col text-center gap-4 justify-center items-center">
                    <h4 className='text-2xl lg:text-5xl font-bold'>Our Awesome Team</h4>
                ...
                <div className="flex flex-wrap justify-between items-center mt-9 gap-4">
