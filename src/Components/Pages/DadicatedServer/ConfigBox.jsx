    ...
    return (
        <div className="border rounded-xl border-neutral-600 mt-5">
            <div className="flex flex-wrap justify-between items-center">
                <div className={`hidden lg:block relative mx-0 w-[8px] lg:h-41 rounded-l-full ${gradientClass}`}></div>
                <div className="flex flex-col gap-3 lg:-ml-9 p-4 lg:p-0">
                ...
                <div className="hidden md:block lg:h-41 w-px bg-neutral-600"></div>
                ...
                <div className='text-center text-[20px] p-2'>
                    <h4>$250.00 /mo</h4>
                </div>
