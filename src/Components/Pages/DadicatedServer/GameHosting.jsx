...
function GameHosting() {
    return (
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30 py-30">    
                <h1 className="text-3xl lg:text-5xl lg:max-w-[20ch] font-bold leading-tight">The Number <span className='gradient-text'>#1 Game Hosting</span>in the Worldwide</h1>
                ...
                <div className="flex flex-wrap md:flex-nowrap">
                    <div className="flex flex-col mt-15 md:border-r border-red-300">
