        ...
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30 pt-30">
                <div className="flex justify-center items-center text-center flex-col">
                    <h1 className='text-3xl lg:text-5xl font-bold'>Why Host With Us?</h1>
                    <p className='mt-4 lg:max-w-2xl'>Easily install and manage your ARK server's Steam Workshop mods (in one click!) with our easy-to-use management interface.</p>
                </div>
                ...
                <div className="mt-5">
                    <div className="relative border border-neutral-600 rounded-2xl h-full md:h-83">
                        <img src="/images/pages/gdf_bg.webp" alt="" className='h-100 lg:h-82.5 w-full' />
                        <div className="absolute inset-0 p-3 md:p-8 flex flex-col justify-center gap-4">
                            <h1 className='text-3xl lg:text-5xl font-bold'>High Performance Hardware</h1>
