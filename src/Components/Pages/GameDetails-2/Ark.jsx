    ...
    <div className='bg-dark text-white'>
      <div className="px-4 lg:px-30 pt-30">
            <div className="flex flex-wrap justify-between items-center gap-6">
                <img src="/images/pages/video_img_2.webp" alt="" className='w-full lg:w-135'/>
                <div>
                    <h1 className='text-3xl lg:text-5xl leading-tight font-bold'>Play ARK: Survival Evolved Multiplayer</h1>
                    <p className='mt-5 lg:max-w-[60ch]'>Get your tribe together and dominate ARK: Survival Evolved multiplayer on our ARK dedicated servers.</p>
                    <p className='mt-8 lg:max-w-[55ch]'>Whether you’re taming ferocious dinos, building epic bases, or battling rival tribes, our servers provide lag-free, high-speed action. Say goodbye to frustrating lag and hello to endless fun and epic adventures with your friends.</p>
