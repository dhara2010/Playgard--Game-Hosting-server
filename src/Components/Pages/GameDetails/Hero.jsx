...
function Hero() {
    return (
        <div className='gradient text-white -mt-150 '>
            <div className="px-4 lg:px-30 pb-10">
                <div className='flex flex-col'>
                    ...
                    <h4 className='mt-5 text-3xl lg:text-6xl font-bold'>ARK: Survival Evolved (PS4)</h4>
                    <div className="grid grid-cols-1 lg:grid-cols-3 mt-10 space-y-6 font-bold text-[18px]">
