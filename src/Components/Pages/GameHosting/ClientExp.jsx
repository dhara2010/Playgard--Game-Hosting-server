...
function ClientExp({ background, children }) {
    return (
        <div className='bg-dark text-white'>
            <div className="px-4 lg:px-30 pt-27">
                <div className="flex flex-wrap gap-15">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="hidden md:block relative overflow-hidden h-[880px]">
                    ...
                    <div className='lg:mt-70 max-w-sm'>
                        <h1 className='text-2xl lg:text-5xl font-bold'>Our Clients' Experiences Speak Volumes</h1>
