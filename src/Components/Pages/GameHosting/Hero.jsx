            ...
            <div className="-mt-150">
                <div className="flex flex-wrap md:flex-nowrap justify-between items-center gap-10">
                    <div className='px-4 lg:px-30'>
                        ...
                        <h1 className="font-bold text-2xl lg:text-6xl max-w-xl mt-3 leading-tight">An Open-World Gaming Server Hosting</h1>
                        ...
                        <div className="flex flex-wrap items-center justify-between w-full mt-8 md:max-w-md">
                            <div>
