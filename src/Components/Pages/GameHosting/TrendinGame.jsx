        ...
        <div className='bg-dark text-white'>
            <div className="px-5 lg:px-30 pt-10">
                <div className="flex flex-col text-center">
                    <p className='lg:text-xl font-bold'>See how over 7,700+ Customers <span className='text-red-500'>Help the world work</span></p>
                </div>
                <div className="flex flex-wrap md:flex-row justify-between lg:gap-10 lg:mt-10">
                ...
                <div className="flex flex-col items-center text-center mt-30">
                    <h1 className='font-bold text-2xl lg:text-5xl'>Discover Trending Games</h1>
                    <p className='max-w-md lg:ml-78 mt-4'>Check out all of the key Aloft game server hosting features that come with your rental: 30+ Games supported at Hostingard</p>
                </div>
