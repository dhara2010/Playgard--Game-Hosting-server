...
function DataCenter() {
    ...
    return (
        <div className='bg-dark'>
            <div className="px-4 lg:px-30 pt-40">
                <h1 className='text-3xl lg:text-5xl font-bold'>Nexcess Data Centers</h1>
                <p className='lg:max-w-220 mt-2'>Easily install and manage your ARK server's Steam Workshop mods (in one click!) with our easy-to-use management interface.</p>
                <div className='mt-10'>
                    <ul className='flex flex-wrap gap-5 text-[18px]'>
