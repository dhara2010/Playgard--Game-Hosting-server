    ...
    <div className='bg-dark text-white'>
      <div className="px-4 lg:px-30 pt-30">
        <div className="flex flex-wrap justify-between items-center gap-6">
          <img src="/images/pages/mcs_img.webp" alt="" className='w-full lg:w-135' />
          <div>
            <h1 className='text-2xl lg:text-5xl leading-tight font-bold'>Which Minecraft Server Types Are Supported?</h1>
            <p className='mt-5 lg:max-w-[60ch]'>Minecraft server hosting plans are fully equipped to support both Java and Bedrock Edition, ensuring all versions are up-to-date with automatic updates.</p>
            <p className='mt-8 lg:max-w-[55ch]'>Our Minecraft server hosting solutions include a one-click installation feature for every server type imaginable, from Spigot and CraftBukkit to Forge and Vanilla, along with all Bedrock Edition servers such as Bedrock Dedicated Server and PocketMine-MP. Additionally, we support all modpacks including CurseForge, Feed The Beast, Technic, ATLauncher, and more.</p>
