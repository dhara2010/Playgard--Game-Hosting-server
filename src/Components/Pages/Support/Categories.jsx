...
function Categories() {
    return (
        <div className='bg-dark'>
            <div className="px-4 lg:px-55 pt-30">
                <h1 className='text-3xl lg:text-5xl text-center font-bold mb-3'>Browse All Categories</h1>
                ...
                <div className="flex flex-col justify-center items-center text-center mt-30 gap-4">
                    <h1 className='text-3xl lg:text-5xl font-bold'>Join today for Premium Web Hosting That’s Fair to you & the Planet.</h1>
                    ...
                    <div className="flex  flex-wrap justify-center items-center gap-5 mt-8 pb-15">
