    ...
    return (
        <div className='-mt-150 text-white'>
            <div className="flex flex-col justify-center items-center gap-5 px-4">
                <h1 className='text-3xl lg:text-7xl max-w-3xl text-center font-bold'>How Can We Help You?</h1>
                <p><span className='text-red-400 font-semibold'>100,000+ Servers</span> powering customers around the world</p>
                <div className="relative lg:w-180 mt-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 px-4 lg:px-30 mt-30 gradient gap-4">
