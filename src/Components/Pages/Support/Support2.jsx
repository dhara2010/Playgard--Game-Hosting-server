...
function Support2({ img }) {
    return (
        <div className="group border border-neutral-600 bg-dark p-3 md:w-88 rounded-3xl">
            <div className="flex justify-between items-center gap-4">
                <img src={img} alt="" />
                <div>
                    <h3 className='text-xl lg:text-2xl font-bold mb-2'>Open Ticket</h3>
                    <p className=''>Open a support ticket for services related issues.</p>
